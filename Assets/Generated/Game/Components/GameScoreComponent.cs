...
public partial class GameContext {
    ...
    public ECS.Components.Game.ScoreComponent score { get { return scoreEntity.score; } }
    public bool hasScore { get { return scoreEntity != null; } }

    public GameEntity SetScore(long newValue) {
        if (hasScore) {
            throw new Entitas.EntitasException("Could not set Score!\n" + this + " already has an entity with ECS.Components.Game.ScoreComponent!",
    ...
    public void ReplaceScore(long newValue) {
...
public partial class GameEntity {
    ...
    public ECS.Components.Game.ScoreComponent score { get { return (ECS.Components.Game.ScoreComponent)GetComponent(GameComponentsLookup.Score); } }
    public bool hasScore { get { return HasComponent(GameComponentsLookup.Score); } }

    public void AddScore(long newValue) {
        var index = GameComponentsLookup.Score;
        var component = (ECS.Components.Game.ScoreComponent)CreateComponent(index, typeof(ECS.Components.Game.ScoreComponent));
